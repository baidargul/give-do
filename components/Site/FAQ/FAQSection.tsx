...
const FAQSection = (props: Props) => {
    return (
        <div className='flex flex-col tablet:flex-row justify-between gap-5'>
            <div className='tablet:w-[43%]'>
                <div className="text-lg tablet:text-[32px] my-2 font-semibold">FAQs</div>
                <div>
                    <div className=''>{props.title}
                        <span className='text-site-bg-redHighlight cursor-pointer'>{props.redLine ? props.redLine : ""}</span>
                    </div>
                </div>
            </div>
