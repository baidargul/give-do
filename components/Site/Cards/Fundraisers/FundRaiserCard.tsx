...
const FundRaiserCard = (props: Props) => {
    ...
    return (
        <Link href={"/fundraisers/template-page/"} className='drop-shadow-md rounded-2xl relative w-auto tablet:h-[559.6px] group cursor-pointer tablet:{hover:scale-105} transition-all '>
            <div className='drop-shadow-md bg-white rounded-2xl'>
                <div className='w-full'>
                    <Image src={"/homepage/missions/1.jpg"} width={384} height={300} alt={"fundraiser"} className='rounded-t-2xl tablet:{h-[300px] w-full object-cover}' />
                </div>
                <div className='p-4 tablet:p-7'>
                    ...
                    {
                        props.urgent && <div>
                            <div className='w-full bg-gradient-to-r from-site-redHighlight/20 p-2 px-4 text-site-redHighlight to-transparent font-semibold flex gap-1 items-center'>
                                <div>
                    ...
                    <div className='mt-4 tablet:{hidden group-hover:block} tablet:mt-0'>
                        <BtnShare red caption='Donate Now' />
                    </div>
                </div>
                {
                    props.urgent && (
                        <div className='hidden tablet:{absolute bottom-0 group-hover:hidden w-full bg-gradient-to-r from-site-redHighlight/20 p-2 px-4 text-site-redHighlight to-transparent font-semibold rounded-b-2xl flex gap-1 items-center}'>
                            <div>
                                <Image src={"/other/warningRed.png"} width={20} height={20} alt='urgent' />
                            </div>
                            <div>Urgent Need of Funds</div>
