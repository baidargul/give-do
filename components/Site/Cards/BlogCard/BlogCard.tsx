...
const BlogCard = (props: Props) => {
    return (
        <div className='rounded-2xl bg-white w-[384px] h-[340px] tablet:h-[372.4px] drop-shadow-md'>
            <div className='w-fit'>
            ...
            <div className='p-4 pt-10 pb-8 flex flex-col justify-between gap-4'>
                <div className='text-[1.2rem] tablet:text-2xl font-semibold line-clamp-2'>
                    7 myths about autism debunked
                </div>
                <div className='text-[.9rem] tablet:text-lg'>
                    1 April 2023
                </div>
            </div>
        </div>
