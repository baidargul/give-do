...
const MissionCard = (props: Props) => {
    return (
        <div className='drop-shadow-md bg-white rounded-2xl tablet:{hover:scale-105} transition-all group cursor-pointer'>
            <div className=''>
                <div className='relative'>
                    <Image src={`/homepage/missions/${props.mission.image}.jpg`} width={395.52} height={341.96} alt={`${props.mission.entity}`} className='rounded-2xl object-cover overflow-clip tablet:{w-[384px] h-[332px]}' />
                    ...
                    <div className='text-[12px] font-semibold px-[12px] py-[4px] absolute top-8 tablet:top-3 bg-site-bg-tag_tax_benefits_available rounded-r-md text-site-text-tag_tax_benefits_available'>Tax Benefits Available</div>
