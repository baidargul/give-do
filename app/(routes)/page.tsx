  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="mt-28 tablet:mt-48 phone:mx-0 tablet:mx-10 laptop:mx-40 px-4 tablet:px-0">
          <SocialChange />
        </div>
        <div className="bg-[#FAF9F9] pt-2 pb-10 mt-28">
          <div className="mt-10 tablet:mt-20 phone:mx-0 tablet:mx-10 laptop:mx-40 mb-20 px-4 tablet:px-0">
            <WhatDoesGiveDo />
          </div>
          <div className="phone:mx-0 tablet:mx-10 laptop:mx-40  px-4 tablet:px-0">
