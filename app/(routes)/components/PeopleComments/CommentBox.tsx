...
const CommentBox = (props: Props) => {
    return (
        <div className='flex flex-col gap-14 rounded-2xl p-5 tablet:w-[384px] bg-white shadow-[inset_-1px_0px_14px_0px_#00000024] hover:shadow-[inset_-1px_0px_14px_0px_rgba(231,66,75,.4)]'>
            <div className='text-[1rem] tracking-wide tablet:tracking-normal tablet:text-[1.25rem] text-site-text-fundraiser_support_description'>
