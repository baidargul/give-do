...
const RaiseFundsSection = (props: Props) => {
    return (
        <div>
            <div className='hidden bg-[#FBEBE6] tablet:{ p-10 tablet:h-[330px] border}' style={{ backgroundImage: "url(/homepage/raisefunds.png)", backgroundRepeat: "no-repeat", backgroundPosition: "right", overflow: "clip", backgroundSize: "550px", backgroundPositionX: "right", backgroundPositionY: "3px" }}>
            ...
            <div className='h-[600px] bg-[#FBEBE6] rounded-2xl tablet:{ p-10 tablet:h-[330px] border}' style={{ backgroundImage: "url(/homepage/raisefunds.png)", backgroundRepeat: "no-repeat", backgroundPosition: "bottom", overflow: "clip", backgroundSize: "350px", backgroundPositionX: "bottom", backgroundPositionY: "3px" }}>
                <div className='flex flex-col tablet:{grid grid-cols-2}'>
                    <div>
                        <div className='text-[1.5rem] text-center tablet:text-left tablet:text-[40px] font-semibold text-site-text-tag_top_donor'>
                            Raise funds for your cause!
